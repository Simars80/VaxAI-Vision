        ...
        >
          <div
            style={{
              ...
              background:
                "linear-gradient(180deg, #111827 0%, #0d1f3c 100%)",
              padding: "48px 28px",
              textAlign: "center",
            }}
          >
            ...
            >
              The VaxAI Vision dashboard is optimised for larger screens.
            </p>
            <Link
              href="/demo"
              style={{
                ...
                textDecoration: "none",
                boxShadow:
                  "0 4px 14px rgba(37,99,235,0.35), 0 0 0 1px rgba(37,99,235,0.15)",
                transition: "all 0.2s",
              }}
            >
              Open Live Demo
